...
insert into foundation_pub.gdt2511_voms_institutes(id,longname,town,country)
  select * from csvread('src/test/resources/db/csv/institutes.csv', null, 'fieldSeparator=|');

insert into foundation_pub.gdt2511_voms_persons(person_id,first_name,name,email,physical_email,institute)
